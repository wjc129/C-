...
def steinmetznew(f, Bm, k1, alpha1, belta1, c, T):
    return k1 * (f ** alpha1) * (Bm ** belta1) * (T**c)
...
# 绘制拟合数据的竖线，使用 vlines
plt.vlines(sample_indices, 0, fitted_values[sample_indices], color='purple', linestyle='solid', label='幂指数修正拟合磁芯损耗')
