...
# 新的 Steinmetz 函数
k1new=1.8989148007914376
alpha1new=1.422904435471711
beta1new=2.4257591794354623
cnew=-5.0451139370162995e-05
...
# 新模型散点图
plt.scatter(predicted_values_new, target_data, color='purple', label='二次偏置模型', alpha=0.6)
...
plt.xlabel('二次偏置预测值')
plt.ylabel('目标值')
plt.title('二次偏置预测值与目标值对比')
plt.legend()
plt.grid(True)
plt.savefig('./02/二次模型模型对比.png')
plt.show()
